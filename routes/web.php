...
Route::get('/gift/{id}', [App\Http\Controllers\HomeController::class, 'editPoint'])->name('gift.point');
...
Route::any('/cart/{id}', [CartController::class, 'removeProduct'])->name('remove.product.cart');
Route::any('/applycoupon', [CartController::class, 'applyCoupon'])->name('applyCoupon.cart');
Route::any('/cancelcoupon', [CartController::class, 'removeCoupon'])->name('remove.coupon.cart');
Route::any('/cancelcoupon/checkout', [CartController::class, 'removeCouponInCheckout'])->name('remove.coupon.checkout');
...
// Admin login
Route::get('/admin/login', [AdminLoginController::class, 'formLogin'])->name('formLoginAdmin');
...
//Admin register
Route::get('/admin/register', [AdminRegisterController::class, 'formRegister'])->name('formRegisterAdmin');
...
Route::get('/admin/list', [AdminHomeController::class, 'adminList'])->name('admins.list');
Route::get('/admin/orders', [AdminHomeController::class, 'order'])->name('orders.list');

Route::get('/admin/coupon/create', [AdminCouponController::class, 'showCreateCoupon'])->name('coupon.create');
Route::post('/admin/coupon/create', [AdminCouponController::class, 'createCoupon'])->name('coupon.create.store');
Route::get('/admin/coupon/list', [AdminCouponController::class, 'showListCoupon'])->name('coupon.list');
...
Route::get('/admin/productsAdd', [AdminProductController::class, 'addProductShow'])->name('products.add.form');

// Route::get('/admin/products/add', [AdminHomeController::class, 'add_product'])->name('products.add.show');
Route::post('/admin/products/add', [AdminProductController::class, 'addProduct'])->name('products.add');
Route::get('/admin/products/edit/{id}', [AdminProductController::class, 'editProduct'])->name('products.edit.show');
Route::post('/admin/products/edit/{id}', [AdminProductController::class, 'updateProduct'])->name('products.edit');
...
Route::post('/admin/events/add', [AdminEventController::class, 'addEvent'])->name('events.add');
...
Route::get('/admin/exchange/add', [AdminEventController::class, 'addExchangeShow'])->name('exchange.add.show');
Route::post('/admin/exchange/add', [AdminEventController::class, 'addExchange'])->name('exchange.add');
